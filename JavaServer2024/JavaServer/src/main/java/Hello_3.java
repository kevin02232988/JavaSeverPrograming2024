...
public class Hello_3 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.append("<!DOCTYPE html><html><head><title>The first servlet file by me</title></head><body><h2>Hello everytone  Do you hear me?</h2><hr><h2>이 메시지는 AI 2학년님이 작성했습니다</h2>   현재시각은");
